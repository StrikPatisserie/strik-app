  ...
  return (
    <article id="product-chocoladeletter" className="flex h-full flex-col overflow-hidden rounded-[1.35rem] bg-[#fff3cf] shadow-[0_12px_34px_rgba(107,35,12,.14)]">
      <div className="relative aspect-[3/4] shrink-0 overflow-hidden">
        ...
        <span className="absolute left-2.5 top-2.5 rounded-full bg-[#d62d1d] px-2 py-0.5 text-[.56rem] font-black uppercase tracking-wider text-white">De klassieker</span>
        <div className="absolute right-2.5 top-2.5 flex gap-1">
          ...
          <button type="button" onClick={onOpenAllergens} aria-label="Bekijk allergenen van chocoladeletters" title="Allergenen" className="flex h-8 w-8 items-center justify-center rounded-full bg-white/95 text-[#9a3d21] shadow-md backdrop-blur transition hover:bg-white"><svg aria-hidden="true" viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3.5 21 20H3L12 3.5Z"/><path d="M12 9v5M12 17.5h.01"/></svg></button>
        </div>
      </div>

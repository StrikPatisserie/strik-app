...
export default function B2BChocolateLetters({
  ...
  return (
    <article id="product-chocoladeletter" className="h-full overflow-hidden rounded-[2rem] bg-[#fff3cf] shadow-[0_18px_55px_rgba(107,35,12,.16)] xl:col-span-2">
      <div className="grid h-full xl:grid-cols-[minmax(0,.78fr)_minmax(0,1.22fr)]">
        <div className="relative aspect-[4/5] shrink-0 overflow-hidden bg-[#eeeae2] sm:aspect-[3/4] xl:aspect-auto xl:h-full">
          <Image src={selectedPhoto.src} alt="" aria-hidden="true" fill sizes="(max-width: 640px) 100vw, (max-width: 1280px) 50vw, 33vw" className="scale-110 object-cover opacity-25 blur-2xl" />
          <Image src={selectedPhoto.src} alt={`Voorbeeld ${selectedPhoto.label.toLowerCase()}`} fill sizes="(max-width: 640px) 100vw, (max-width: 1280px) 50vw, 33vw" className="object-contain p-3 sm:p-5" />

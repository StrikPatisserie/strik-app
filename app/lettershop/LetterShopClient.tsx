...
type CartLine = { flavour: Flavour; letter: string; size: Size; quantity: number; logoFile?: File };
...
export default function LetterShopClient() {
  ...
  const hasLogo = cart.some((line) => Boolean(line.logoFile));

...
function strik_revenue_normalize_cash_record($record) {
    ...
    return array(
        ...
        'cashOut' => isset($record['cashOut']) ? round((float) $record['cashOut'], 2) : null,
        'receipts' => isset($record['receipts']) ? round((float) $record['receipts'], 2) : null,
        ...
        'iceDifference' => isset($record['iceDifference']) ? round((float) $record['iceDifference'], 2) : null,
        'iceCountedBy' => isset($record['iceCountedBy']) ? strik_revenue_text($record['iceCountedBy'], 120) : '',
        'iceOpenedAt' => isset($record['iceOpenedAt']) ? strik_revenue_text($record['iceOpenedAt'], 40) : '',
        'iceClosedAt' => isset($record['iceClosedAt']) ? strik_revenue_text($record['iceClosedAt'], 40) : '',
        'iceSafeCash' => isset($record['iceSafeCash']) ? round((float) $record['iceSafeCash'], 2) : null,
        'iceSafeDifference' => isset($record['iceSafeDifference']) ? round((float) $record['iceSafeDifference'], 2) : null,
        'iceCheckedAt' => isset($record['iceCheckedAt']) ? strik_revenue_text($record['iceCheckedAt'], 120) : '',
        'iceCheckedBy' => isset($record['iceCheckedBy']) ? strik_revenue_text($record['iceCheckedBy'], 120) : '',
        'iceNote' => isset($record['iceNote']) ? strik_revenue_text($record['iceNote']) : '',
...
function strik_revenue_normalize_cash_deposit($record) {
    ...
    return array(
        ...
        'closedAt' => isset($record['closedAt']) ? strik_revenue_text($record['closedAt'], 120) : '',
        'closedBy' => isset($record['closedBy']) ? strik_revenue_text($record['closedBy'], 120) : '',
        'cashbookBookedAt' => isset($record['cashbookBookedAt']) ? strik_revenue_text($record['cashbookBookedAt'], 120) : '',
        'cashbookBookedBy' => isset($record['cashbookBookedBy']) ? strik_revenue_text($record['cashbookBookedBy'], 120) : '',
        'note' => isset($record['note']) ? strik_revenue_text($record['note']) : '',
